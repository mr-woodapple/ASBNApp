...
namespace ASBNApp.DataAPI.Migrations
{
    ...
    [Migration("20250130083751_UpdatedWorkLocationAndEntryModel")]
    partial class UpdatedWorkLocationAndEntryModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ASBNApp.DataAPI.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("ApprenticeshipStartDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("LegalRepresentitive")
                        .HasColumnType("nvarchar(max)");
